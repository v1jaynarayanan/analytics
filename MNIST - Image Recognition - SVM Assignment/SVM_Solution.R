...
# Write to file
ImageId <- seq.int(nrow(mnistTest))
output_df <- as.data.frame(ImageId)
output_df$Label <- Eval_Final_model

write.csv(output_df, "vijay_kaggle_submission.csv", row.names = FALSE)
